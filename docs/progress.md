...
- [~] 6d. Services template: built + on staging 2026-09-25 (code v0.4.0; next-card spacing fixed). Rail = all services done + verified 2026-09-25. Waiting on Angelino's OK
